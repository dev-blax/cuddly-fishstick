export const applicationCardData = [
  {
    label: "APPLY FOR IDEA STAGE",
    description:
      "Idea stage is a common way to describe the early stages in an innovation process that involves brainstorming and filtering a large number of ideas until you are left with your best idea that is documented as a business case.",
    imageString: "/images/apply/idea.jpg",
    href:'/idea-application'
  },
  {
    label: "APPLY FOR STARTUP STAGE",
    description:
