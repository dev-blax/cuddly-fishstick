...
BlockOptionsDropdownList.propTypes = {
  ...
  setShowBlockOptionsDropDown: PropTypes.func.isRequired,
};
...
export function AdminEditor() {
  ...
  return (
    <div>
      ...
      <div className=" relative mx-auto overflow-hidden my-5 w-full min-w-[900px] max-w-xl rounded-xl border border-gray-300 bg-white text-left font-normal leading-5 text-gray-900">
        <ToolbarPlugin />
